...
$data = 'birth_year=1976&name='.$nama.'&password='.$password.'&email='.$email.'&creation_point=client_mobile&gender=female&key=142b583129b2df829de3656f9eb484e6&platform=Android-ARM&iagree=true&birth_month=10&birth_day=5&password_repeat='.$password.'';
$headers = array();
...
$url = "https://spclient.wg.spotify.com:443/signup/public/v1/account/";
$data = 'birth_year=1976&name='.$nama.'&password='.$password.'&email='.$email.'&creation_point=client_mobile&gender=male&key=142b583129b2df829de3656f9eb484e6&platform=Android-ARM&iagree=true&birth_month=6&birth_day=4&password_repeat='.$password.'';
$headers = array();
$headers [] = "User-Agent: Spotify/8.4.98 Android/25 (Custom)";
$headers [] = "Spotify-App-Version: 849800892";
$headers [] = "X-Client-Id: 9a8d2f0ce77a4e248bb71fefcb557637";
$headers [] = "App-Platform: Android-ARM";
$headers [] = "Content-Type: application/x-www-form-urlencoded";
$headers [] = "Host: spclient.wg.spotify.com";
